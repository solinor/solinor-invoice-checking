...
urlpatterns = [
    ...
    url(r'^weekly_report/(?P<invoice_id>[0-9A-Fa-f-]+)/pdf/(?P<pdf_type>.+)$', invoices.views.get_pdf, name="get_pdf"),
    ...
    url(r'^personweek/(?P<user_guid>[0-9A-Fa-f-]+)/(?P<year>[0-9]{4})/(?P<week>[0-9]{1,2})',invoices.views.person_details_week, name='person'),
